...
import static com.example.android.project8.R.string.news;
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                JSONObject items = newsArray.getJSONObject(i);

                String title = items.getString("webTitle");

                String sectionName = items.getString("sectionName");

                String url = items.getString("webUrl");
